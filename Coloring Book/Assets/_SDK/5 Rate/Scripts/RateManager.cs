...
namespace HG.Rate
{
    ...
    public class RateManager : MonoBehaviour
    {
        ...
        DG.Tweening.Sequence sequence1, sequence2;
        bool showFB = false;
        ...
        public void ShowPopup()
        {
           ...
           sequence1?.Kill();
            ...
            sequence1.Join(container.DOAnchorPosY(0, effectTime).SetEase(DG.Tweening.Ease.Linear));
        ...
        public void HidePopup()
        {
            ...
            sequence1?.Kill();
            sequence1 = DOTween.Sequence();
            sequence1.Append(container.DOAnchorPosY(-panelHeight, effectTime).SetEase(DG.Tweening.Ease.Linear));
        ...
        void ShowFeedback()
        {
            ...
            sequence2.Append(starRow.DOMove(topPoint.position, effectTime).SetEase(DG.Tweening.Ease.Linear));
            sequence2.Join(feedbackObj.transform.DOScale(1, effectTime).SetEase(DG.Tweening.Ease.Linear));
        }
