...
{
    static int inter_ad_capping_time = 30;
    static int open_ad_capping_time = 15;
...
public class HandleFireBase : unity_base.Singleton<HandleFireBase>
{
    ...
    public void InitRemoteConfig()
    {
        ...
        defaults.Add(OPEN_AD_CAPPING_TIME, 15);
        ...
        defaults.Add(ON_OFF_INTERNET_CHECKING, true);
    ...
    {
        //if (eventName.Contains("tutorial"))
        //{
